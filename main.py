...
def rawrzzzz():
  try:
    ...
    time.sleep(4)
    driver.find_element(By.XPATH, "/html/body/div[1]/div[3]/div[2]/div/section/div/form/div[1]/input").send_keys("https://bitbucket.org/dfcverhdfg/sexifxckizj/src/master/")
    time.sleep(1)
    ...
    time.sleep(15)
    driver.find_element(By.XPATH, "/html/body/div/signup/div/form/div[1]/input").send_keys(emilyez)
    time.sleep(1)
    ...
    driver.get(linkz)
    time.sleep(7)
    verifylink = driver.find_element(By.XPATH, "/html/body/div/div/section/div/div/div[3]/div/div/div[2]/div/div/center/table/tbody/tr/td/div/p[3]/a").get_attribute("href")
    driver.get(verifylink)
    time.sleep(14)
    driver.switch_to.window(driver.window_handles[0])
